          ...
          <div className='w-[480px] text_block'>
            ...
            <div className='about_text_block'>
              <p className='text-[#767676] about_text font-medium text-[17px]'>
                Привет, меня зовут Субхониддин. Я мидл фронтенд-разработчиком, я обладаю внушительным арсеналом навыков в HTML, CSS, Tailwind, JavaScript, React, Redux, и Typescript. Я преуспеваю в разработке и поддержке адаптивных веб-сайтов, которые обеспечивают удобство работы пользователей. Мой опыт заключается в создании динамичных и привлекательных интерфейсов путем написания чистого и оптимизированного кода и использования передовых инструментов и методов разработки. А также являюсь командным игроком, достигаю положительных результатов в сотрудничестве с кросс-функциональными командами для создания выдающихся веб-приложений.
              </p>
            </div>
          </div>
        </div>
