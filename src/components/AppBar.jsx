  ...
  return (
    <div className='shadow-md w-full fixed top-0 bg-slate-900 left-0 z-[15]'>
      <div className='md:flex text-white bg-slate-900 items-center justify-between py-4 md:px-10 px-7'>
        ...
        <ul
          className={`md:flex md:items-center backdrop-blur-xl z-[-3] md:pb-0 pb-12 absolute md:static md:z-auto left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
