...
const AboutPage = () => {
  return (
    <div className="flex mx-auto items-center justify-center pt-6">
      <div className="w-[230px] h-[550px] flex md:flex-col justify-between">
        <div className="flex justify-center items-center w-full h-[230px] shadow-lg shadow-slate-800 rounded-2xl">
      ...
      <div className="flex justify-center items-center w-[220px] h-[320px] shadow-lg shadow-slate-800 rounded-2xl">
